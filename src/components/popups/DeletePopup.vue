  ...
  >
      <div class="popup__inner">
          <span
            ...
            @click="goBack"
          >&#10006</span>
          <p class="popup__text">Данное действие приведет к удалению контакта</p>
          <button
            @click.self="deleteContact(+this.$route.params.id)"
...
export default {
  ...
  methods: {
    deleteContact(idItem) {
      this.$store.dispatch('DELETE_CONTACT', idItem)
      this.$router.go(-1)
    }
  },
  goBack () {
